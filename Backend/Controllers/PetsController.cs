  ...
  public class PetsController : Controller
  {
    ...
    public PetsController(SpotAlertContext context)
    {
      ...
      if (_context.Pets.Count() == 0)
      {
        ...
        _context.Pets.Add(new Pet() { Id = 2, Name = "Bobo", Image = "https://www.vetwest.com.au/sites/default/files/styles/large/public/images/article/breed-beagle.jpg", LastKnownLoc = "Santa Ana, CA", Status = "not lost", LostSince = "05/31/17", Description = "Beagle hound, brown and white, very friendly", OwnerId = 1});
        _context.Pets.Add(new Pet() { Id = 3, Name = "Buddy", Image = "https://cdn.shopify.com/s/files/1/0287/8140/products/2015_12-Fritz_Weekend_1024x1024.jpg?v=1477243647", LastKnownLoc = "Westminster, CA", Status = "not lost", LostSince = "01/23/18", Description = "Brown stripes, likes to wear his denim blue and white polka dotted collar bow", OwnerId = 1});     
        ...
        _context.Pets.Add(new Pet() { Id = 5, Name = "Misty", Image = "https://cdn.thinglink.me/api/image/767377576548106240/1240/10/scaletowidth", LastKnownLoc = "Laguna Hills, CA", Status = "not lost", LostSince = "10/31/17", Description = "Unicorn cat with the colors of the rainbow", OwnerId = 2});
        _context.Pets.Add(new Pet() { Id = 6, Name = "Rocky", Image = "https://www.what-dog.net/Images/faces2/scroll006.jpg", LastKnownLoc = "Riverside, CA", Status = "not lost", LostSince = "06/21/17", Description = "Brown and white, fluffy", OwnerId = 2});
        ...
        _context.Pets.Add(new Pet() { Id = 9, Name = "Molly", Image = "https://static.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg", LastKnownLoc = "Hacienda Height, CA", Status = "not lost", LostSince = "02/27/17", Description = "Pure white and blue eyes", OwnerId = 3});
        ...
        _context.Pets.Add(new Pet() { Id = 11, Name = "Jude", Image = "https://strikingattheroots.files.wordpress.com/2015/06/white-rabbit.jpg", LastKnownLoc = "Buena Park, CA", Status = "not lost", LostSince = "01/17/18", Description = "Pure white, very nice and shy", OwnerId = 3});        
        _context.Pets.Add(new Pet() { Id = 12, Name = "Tucker", Image = "https://www.dogtopia.com/santa-ana-south-coast/wp-content/uploads/sites/110/2016/01/dog-sit-homepage1.png", LastKnownLoc = "Cypress, CA", Status = "not lost", LostSince = "12/15/17", Description = "Black and white spotty like from 101 Dalmatians", OwnerId = 3});
        ...
        _context.Pets.Add(new Pet() { Id = 15, Name = "Bella", Image = "https://www.dabneydriveanimalhospital.com/wp-content/uploads/2011/02/63324259.jpg", LastKnownLoc = "Huntington Beach, CA", Status = "not lost", LostSince = "12/24/17", Description = "Pure white with dark brown left ears", OwnerId = 4});
        ...
        _context.Pets.Add(new Pet() { Id = 17, Name = "Lucy", Image = "http://hrschicago.com/wp-content/uploads/2012/02/1294076092_iStock_000008593092XSmall.jpg", LastKnownLoc = "Cerritos, CA", Status = "not lost", LostSince = "08/23/17", Description = "Light brown and white", OwnerId = 5});        
