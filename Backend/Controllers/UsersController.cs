...
namespace Backend.Controllers
{
  ...
  public class UsersController : Controller
  {
    ...
    public UsersController(SpotAlertContext context)
    {
      ...
      {
        _context.Users.Add(new User() { Id = 1, FirstName = "Bobby", LastName = "Lee", Email = "bobbylee@gmail.com", Password = "1234", ConfirmPassword = "1234", PhoneNumber = "(523) 584-6058", Address = "7246 W. Windsor Dr., Carmichael, CA 95608", MessageDate = "01/20/18", Message = "Hi Bobby, I found your dog. She is currently safe with me. I can tell that she is very scared and misses her home and especially her family. Please give me a call or an email as soon as possible.", MessageName = "Emma", MessageNumber = "(543) 345-8690", MessageEmail = "emma@gmail.com", MessageRegarding = "Mia"});
